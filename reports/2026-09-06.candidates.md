...
### 4. Configuration-space Bayesian optimisation for stress-critical pose identification on a hyper-redundant robot
...
### 5. An integrated machine learning and computational framework with experimental validation for the identification of novel CXCR4 inhibitors.
...
### 7. Second-generation N,N′-disubstituted aliphatic diamines: discovery of potent hits for multi-species leishmaniasis treatment
...
### 8. Persistent Local Laplacian Prediction of Protein–Ligand Binding Affinities
...
### 9. From PROTACs to Clinical Reality: A Narrative Review of Targeted Protein Degradation Therapies
...
### 10. De novo design of CR2 binder as vaccine scaffold
...
### 11. Evolving transition-state search with agentic large language models
...
### 12. Retrieval of binding sites across the AlphaFold human proteome using protein language model representations
...
### 13. QRL-FP: a quantum-inspired reinforcement learning framework for multi-objective system-on-chip floorplanning
...
### 14. Maritime search and rescue operations planning: A hybrid approach for multi-asset deconfliction and efficient resource allocation
...
### 15. HSSynergy: scale-aware hierarchical attention for interpretable drug synergy prediction
...
### 18. Three-dimensional magnetotelluric Bayesian inversion based on Stein variational gradient descent
...
### 19. Machine Learning-Assisted Optimization of CMOS VLSI Circuits for Low-Power and High-Speed Applications
...
### 21. Robust PAC Learning of Concurrent Stochastic Games
...
### 22. Integrating R&D space projects into aerospace engineering master's education at MCAST
...
### 23. A hawk-inspired metaheuristic for trajectory optimization of UAVs in precision agriculture
...
### 24. Q-Edge: Symmetry-Reduced Quantum Simulation of Structured Extreme Dependence
...
### 25. ESPO: Error-Structured Prompt Optimization via Diagnose, Diversify, and Stabilize
...
### 26. Background proteome correction promotes confident identification of dynamic protein-protein interactions between different biological contexts
...
### 27. ALRA: Adaptive Local Relational Alignment for Logit-Based Pre-training Distillation of Autoregressive Language Models
...
### 28. Zero-Shot Novel Depth Synthesis Using 3D Foundation Models Scene Representations
...
### 29. A multiscale analysis of liver lobule fibrosis and its impact on drug propagation and metabolism - a DLA approach

**Authors:** Coombe, D., Rezania, V., Tuszynski, J.
**Date:** 2026-09-03
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/09/03/2026.08.28.747748.source.xml
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 30. A survey of world models for physical AI with uncertainty representation and control

**Authors:** Sven Kirchner, Nils Purschke, Alois Knoll
**Date:** 2026-09-03
**Source:** openalex
**Link:** https://doi.org/10.1007/s44163-026-02122-1
**Code:** Not found

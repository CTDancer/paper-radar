...
### 3. Penalization method to convert Bayesian optimization methods into batch multi-objective Bayesian optimization methods
...
### 5. ExpertVerse: A General-Purpose Benchmark for Expert-Level Reasoning in Knowledge-Intensive Visual Synthesis
...
### 6. Prioritizing neuroactive ligands using motif-guided virtual discovery and zebrafish profiling
...
### 7. Abstract B049: Discovery of a small-molecule degrader targeting the intracellular immune checkpoint CISH
...
### 8. AI-Driven Multi-Objective Optimization of Floating Photovoltaic-Thermal Systems with MATLAB-HOMER Pro Validation
...
### 9. Multi-Objective Optimization of Studs in Steel–Concrete Composite Beams
...
### 10. Experimentally Tuned Protein-RNA Rosetta Score Function using Bayesian Optimization
...
### 13. Preliminary Assessment of p-Anisidinium-Based Ionic Solids as Potential DNA Staining Agents: DFT and Molecular Docking Studies
...
### 14. From vehicles to wildlife: transferable deep learning for trajectory generation
...
### 15. Kernel-Based Learning of Safety Barriers
...
### 20. Assessing the Stability of Molecular Glues with Weighted Ensemble Simulations.
...
### 23. OmniReasoner: Thinking with Long Audio-Video via Native Tool Use
...
### 24. Copy Less, Ground More: Overcoming Repetitive Copying in Long-Context Reasoning via Evidence-Aware Reinforcement Learning
...
### 26. ISO: An RLVR-Native Optimization Stack
...
### 28. Structure-guided targeting of the GATAD2A-CHD4 interaction within the MBD2-NuRD complex results in high levels of HbF in adult erythroid cells

**Authors:** Shengzhe Shang, Sangam Giri Goswami, Tory Li, Wang He, Christopher R. Travis, Mikhail G. Dozmorov, David C. Williams, Gordon D. Ginder
**Date:** 2026-07-20
**Source:** openalex
**Link:** https://doi.org/10.64898/2026.07.17.739209
**Code:** Not found
...
### 29. Stochastic Polynomial Surrogate Models for Uncertainty Quantification of Offshore Plate Anchor Capacity

**Authors:** Negin Yousefpour, B Z Wang, Changjian Zhou, Alessio Mentani
**Date:** 2026-07-21
**Source:** openalex
**Link:** https://doi.org/10.1007/s10706-026-03824-0
**Code:** Not found
**Tags:** black_box_combinatorial_and_expensive_optimization
**Priority hint:** Archive
**Paper type:** method

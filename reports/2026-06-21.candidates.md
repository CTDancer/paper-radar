...
### 2. Elucidating the Design Space of Generative Models for Single-Cell Perturbation Prediction
...
### 3. WITHDRAWN: PolyFold: Evaluation of Open-Use Molecular Structure Prediction Algorithms to Inform Their Utility in Diverse Biological Applications
...
### 5. A data-driven rediscovery of the specificity-conferring code of adenylation domains in nonribosomal peptide synthetases
...
### 6. Artificial Intelligence in Chemical Process Optimization: Techniques, Applications, Challenges, and Future Directions
...
### 9. Enhancing Machine Learning models of biogas production in wastewater treatment plants using hybrid Bayesian optimization based on Gaussian process
...
### 10. Benchmarking gene expression reconstruction from single-cell latent representations
...
### 11. Parametric Engineering of Atrioventricular Living Valve Transplants
...
### 13. DiscoVerse: multi-agent pharmaceutical co-scientist for traceable drug discovery and reverse translation
...
### 14. Trichomonas vaginalis PPi-dependent phosphofructokinase structures reveal a non-canonical nucleotide binding site
...
### 16. Identification of novel DNA gyrase B inhibitors in Mycobacterium species using integrated computational approaches
...
### 17. Predictability as a Fine-Grained Measure for Privacy
...
### 19. Multitargeted comparative evaluation suggests 2-Aoeobenoxmide shows favourable in silico binding compared to Tucatinib against ERα, HER2, AKT1, EGFR, and PIK3CA in breast cancer
...
### 22. How Do Instructions Shape Speech? Cross-Attention Attribution for Style-Captioned Text-to-Speech
...
### 24. A robust machine learning framework for detecting temporal drift in financial fraud prevention
...
### 25. RNA 3D Motif Dynamics Guide Assembly of the Replication Initiation Complex in Flaviviruses

**Authors:** Streit, L. V., Onikubo, T., Astore, M. A., Cioppa, E. A., Olinares, P. D. B., Urnavicius, L., Incarnato, D., Bonilla, S. L.
**Date:** 2026-06-18
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/06/18//2026.06.16.732768.source.xml
**Code:** Not found
...
### 27. A hybrid framework integrating structural machine learning and 3D liver-on-chip assay for drug-induced liver injury prediction

**Authors:** Zhang, F., Zhou, Y., Ding, D., Zhang, F., Xiao, R., Ai, X.
**Date:** 2026-06-18
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/06/18//2026.06.15.732231.source.xml
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 29. SARLO-80: Worldwide Slant SAR Language Optic Dataset 80cm

**Authors:** Solène Debuysère, Nicolas Trouvé, Nathan Letheule, Elise Colin, Georgia Channing
**Date:** 2026-06-18
**Source:** arxiv
**Link:** http://arxiv.org/abs/2606.20523v1
**Code:** Not found
**Tags:** medicinal_and_synthetic_chemistry
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 30. Bioinf-Farma: supervised integration of epitope prediction and recombinant protein developability for automated vaccine candidate prioritization

**Authors:** Bondi, H., Crespi, M., Orlando, M., Lescai, F., Serapian, S. A., Colombo, G., Fasano, M., Pollegioni, L.
**Date:** 2026-06-18
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/06/18//2026.06.15.732271.source.xml
**Code:** Not found
**Tags:** protein_design
**Priority hint:** Archive
**Paper type:** benchmark_dataset

...
### 4. Incorporating Surfaced-Induced Dissociation Mass Spectrometry Data into an AlphaFold-derived deep learning network improves protein structure prediction
...
### 5. Can Tabular In-Context Learners Generalize to Biomolecular Property Prediction?
...
### 6. Systematic comparison of color representations between humans and deep neural networks: towards predicting human color perception in a vast color space
...
### 8. Artificial intelligence in clinical oncology: Multimodal integration and translational development.
...
### 9. RNArefine: AI-guided Atomic-Level Refinement of RNA Structures
...
### 10. SentryPath: a mechanistic protocol-ranking simulator with leave-one-trial-out cross-validation across 13 phase-III oncology randomised controlled trials and a pre-registered prospective forecast
...
### 11. On the Convergence of Self-Improving Online LLM Alignment
...
### 14. A substrate recursion principle for biological information, with empirical anchoring through a templating-mode taxonomy
...
### 16. Resolving superposition in AI for interpretability and cross-modal alignment in patient-neuronal images
...
### 17. EnzyKAN: Protein Language Model Embeddings and Kolmogorov-Arnold Network Variants for Enzyme Commission Classification with a Proposed Electron-Transfer Physics Feature Framework
...
### 18. FedLAB: Traceable Semantic Codebooks for Federated Multimodal Graph Foundation Learning
...
### 19. Random Reshuffling Dominates Stochastic Gradient Descent
...
### 20. FaceMoE: Mixture of Experts for Low-Resolution Face Recognition
...
### 21. Selective knockout of PKA regulatory subunits reveal opposite catalytic and metabolic consequences with implications for Alzheimer's disease
...
### 22. Modeling Cell-Cycle-Aware Single-Cell Drug Perturbation Responses
...
### 23. Policy Optimization Achieves Data-Dependent Regret Bounds in MDPs with Unknown Transitions
...
### 24. Digging deeper into the immunopeptidome with TripleToolWF
...
### 25. Cross-Space Distillation: Teaching One-Step Students with Modern Diffusion Teachers
...
### 26. Practical Use of Advanced AI Frameworks on Real-Life Scientific Problems: Three Case Studies
...
### 27. CoMet: Context and Multiplicity Decomposition for Multimodal Uncertainty Estimation
...
### 28. Learning Fragmentation Physics or Exploiting Sequence Priors? Benchmarking Bias in Deep Learning Models for De Novo Peptide Sequencing

**Authors:** Li, J., Rost, H.
**Date:** 2026-06-29
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/06/29//2026.06.23.734131.source.xml
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset

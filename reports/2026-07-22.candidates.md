...
### 5. Artificial Intelligence and Protein Design: A retrospective study on 20-year emerging trends and core research areas from bibliometric perspectives.
...
### 6. Biocatalytic reduction of nitro-sulfonamides: enzyme engineering, process integration, and sustainable pathways to p-aminobenzenesulfonamide
...
### 7. The Many Senses of Visual Similarity: A Text-Prompted Image Perceptual Metric
...
### 8. Learning Adaptive Safety Margins for Visual Navigation
...
### 9. A lightweight, integrated generative AI assistant for accelerated early-stage drug discovery on constrained-resource hardware.
...
### 13. Performance and energy consumption balanced optimization of ternary optical computers based on partially synchronous vacation queuing
...
### 14. Intelligent UAV Trajectory Design and Task Offloading for UAV-Assisted Edge Computing in Urban Road Scenarios
...
### 15. Simple Domain Generalization for Strong Pixel-Level Image Tampering Detection in Modern VLMs

**Authors:** Yi Tang, Xinyi Shang, Jiacheng Cui, Sondos Mahmoud Bsharat, Jiacheng Liu, Xiaohan Zhao, Tran Dinh Tien, Ahmed Elhagry
**Date:** 2026-07-20
**Source:** arxiv
...
### 16. Enterprise LLM Router: Learning Quality–Capacity–Capability Trade-offs from 2026 Model Metadata
...
### 17. Attention-based Spatio-Temporal Graph Convolutional Networks-enhanced deep reinforcement learning for adaptive traffic signal control in urban traffic networks
...
### 18. COVAriance-Induced Fairness Gap Penalty for Subgroup-Fair Clustering

**Authors:** Kyungseon Lee, Hankyo Jeong, Kunwoong Kim, Kwanho Lee, Yongdai Kim
**Date:** 2026-07-20
**Source:** arxiv
**Link:** http://arxiv.org/abs/2607.18119v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 20. Vector Search As Nearest Neighbor Matching: RAG-based Policy Learning in Causal Inference
...
### 21. OR Else: A Differentiable Trust Region for Policy Optimization
...
### 22. An efficient adaptive dimension selection algorithm for multidimensional probit graded response models

**Authors:** Yu Zhou, Yincai Tang, Bin Lv, Meng Gao
**Date:** 2026-07-20
**Source:** arxiv
**Link:** http://arxiv.org/abs/2607.17654v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 23. A lightweight hybrid deep learning framework for multi-pill detection, multi-attribute recognition, OCR-based imprint analysis, and metadata retrieval
...
### 24. AI-Driven Iterative Model for Accelerated ATC Computation under Transmission Congestion using Hybrid Forecasting, Deep Feature Compression, and Physics-Informed Optimizations
...
### 25. Aligned and realistic latent diffusion for text-to-motion generation
...
### 26. Nanosystems for delivery of indolicidin peptide
...
### 27. Risk-sensitive exit-time control for stochastic differential equations with path-dependent coefficients

**Authors:** David Criens, Fabian Fuchs
**Date:** 2026-07-20
**Source:** arxiv
**Link:** http://arxiv.org/abs/2607.18192v1
**Code:** Not found
**Tags:** stochastic_processes_probability_statistical_physics
**Priority hint:** Archive
**Paper type:** weak_match
...
### 28. Learning to read a second language establishes a parallel L2 representation alongside the native one in the VWFA
...
### 29. Topological Signatures of Context-Level Reliability in TabPFN

**Authors:** James Hu, Mahdi Ghelichi
**Date:** 2026-07-20
**Source:** arxiv
**Link:** http://arxiv.org/abs/2607.17962v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 30. Bounded personality diversity boosts collective intelligence: a swarm optimization approach

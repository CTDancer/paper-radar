...
### 5. Optimized Multiple Circular Sequence Alignment for Cyclic Peptide Motif Discovery
...
### 6. ConfDock: Atom-specific Uncertainty Quantification for Molecular Docking via Conformal Prediction
...
### 7. PG-MLD: Physics-Guided Molecular Representation Learning via Dynamic 3D Trajectory Distillation
...
### 8. Surrogate-based multi-disciplinary design optimization of passive morphing aeroelastic composite unmanned aerial vehicle wings
...
### 9. Unique Step Refinement for Transformer-Based Generative Models
...
### 10. Generation of antifungals to combat drug resistance using language models and diffusion models.
...
### 11. Benchmarking Deep Learning Predictions of Mutation-Induced Fold Switching
...
### 13. In vitro antiamoebic activity of novel metronidazole derivatives and silver nanoparticle formulations against clinical isolates of Entamoeba histolytica
...
### 16. Temporal-spatial reasoning over hypergraph knowledge structures for multimodal retrieval-augmented generation
...
### 17. An alphabet of allostery: a transferable transfer entropy contact patterns predicts allosteric-site character and conformational rewiring
...
### 18. An end-to-end framework for single-cell-resolution, whole-transcriptomic spatial profiling in post-mortem human brain
...
### 19. SPINDLE: Unlocking protein dynamics from single-field NMR relaxation data using a deep learning ensemble.
...
### 20. Prompting Beyond Pairs: Decoupled Semantic Supervision for Knowledge-Guided Multiplex Virtual Staining
...
### 21. CPPLocPred: Subcellular Localization of Cell-Penetrating Peptides
...
### 22. Integrated computational and in vitro analysis reveals the toxic mechanisms of PFAS in female diminished ovarian reserve
...
### 23. Acaricidal activity of silver nanoparticles biosynthesized from unripe fruits of Solanum elaeagnifolium Cav. against Tetranychus urticae Koch
...
### 24. Mobility-Aware and Privacy-Preserving Federated Reinforcement Learning with Multi-Paradigm Machine Learning for Edge Intelligence in 5G/6G Networks
...
### 25. Passenger density prediction and gate allocation via GA-optimized ELM
...
### 26. Mouse suppressyn-like 1 suppresses membrane fusion through envelope glycoprotein recognition
...
### 27. Stepwise and lineage-specific divergence of a major immune co-chaperone complex in leptosporangiate ferns
...
### 28. MetaAMI: A Novel Meta-Learning Approach for Predicting In-Hospital Mortality in Acute Myocardial Infarction
...
### 29. Gradient usability in few-qubit quantum Neural Networks: A signal-to-noise ratio framework for evaluating mitigation strategies
...
### 30. Efficient deoxygenation of palm oil to green diesel using a metal oxide catalysts supporting on ZrO2-enhanced graphene oxide

**Authors:** Attared F. Hassan, Hassan T. Abdulsahib, Faris A. J. Al-Doghachi, Taufiq Yun Hin Yap
**Date:** 2026-10-30
**Source:** openalex
**Link:** https://openalex.org/W7172188575
**Code:** Not found

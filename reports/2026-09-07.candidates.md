...
### 13. Structural identification of the RY12 domain of RyR1 as an ADP sensor and the target of the malignant hyperthermia therapeutic dantrolene
...
### 15. Research on decoupling inversion analysis of rockfill dam parameters considering dam zoning and material uncertainty: the case study of a concrete face rockfill dam
...
### 16. An explainable AI framework for crack width and crack spacing prediction with serviceability-oriented design optimization of reinforced and prestressed concrete members
...
### 18. Experimental and In Silico Analysis of the Structural Dynamics of Dengue NS2B-NS3 Protease
...
### 19. Seq2Seq2Seq: lossless data compression via discrete latent transformers and reinforcement learning
...
### 20. QuickSeg: A fast, versatile and accurate algorithm for genomic copy number segmentation using dynamic programming
...
### 22. A review of artificial intelligence data-driven methods in building energy management: A comprehensive application-based of recent advances
...
### 23. Higher-order epistasis drives evolutionary unpredictability toward new antibiotic resistance
...
### 24. A hawk-inspired metaheuristic for trajectory optimization of UAVs in precision agriculture
...
### 25. A Representation-Based Sum-Product Neural Network for Higgs Boson Event Classification
...
### 26. On doubting image quality assessment metrics for microscopy virtual staining
...
### 27. From global optimization to transition state search: an automated workflow for surface reaction barriers
...
### 28. An Integrated Single-Nucleus Atlas Resolves Cell-Type-Specific Programs and Molecular Subtypes in Alzheimer's Disease
...
### 29. A novel model-based biclustering for ordinal data via a URV approach

**Authors:** Monia Ranalli, Francesca Martella
**Date:** 2026-09-04
**Source:** openalex
**Link:** https://doi.org/10.1007/s00180-026-01793-9
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 30. Efficient Resource Management in 6G for Sustainable Spectrum Allocation Using Dual‐Channel Temporal Convolutional Frequency‐Separated Attention Network with Generation Rights Trading Blockchain

**Authors:** Manimaran Arjunan, Vivek Jain, Kalyan Kasturi, C. Kanmani Pappa
**Date:** 2026-09-04
**Source:** openalex
**Link:** https://doi.org/10.1002/dac.70603
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method

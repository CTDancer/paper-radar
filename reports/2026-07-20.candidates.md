...
- Raw candidates: 171
- Deduplicated candidates: 118
- Candidate count: 30

## Candidates

### 1. AI-assisted fragment-based drug discovery of SARS-CoV-2 macrodomain binders validated by NMR and X-ray crystallography
...
### 4. Integrated Phytotherapeutic Approach in Preventing Neuroleptic-Induced Cardiotoxicity and Parkinsonism: In Silico Study and Molecular Biomechanisms of Crataegus monogyna and Agrimonia eupatoria Phytocomplexes
...
### 5. A Glycan-Aware Diffusion Model for Carbohydrate and Glycoprotein Structure Prediction
...
### 6. Enhancing Offline Model-Based RL via Active Model Selection: A Bayesian Optimization Perspective
...
### 7. Multi-objective optimization framework for dynamic energy management in hybrid microgrids using NSGA-III
...
### 9. Fluorescence cross-correlation spectroscopy quantifies affinity, cooperativity, and kinetic stability in ternary protein complexes
...
### 10. A tailored CoA ligase–N-acyltransferase cascade for on-DNA amide bond formation gives access to broad substrate scope
...
### 11. Artificial Intelligence and Protein Design: A retrospective study on 20-year emerging trends and core research areas from bibliometric perspectives.
...
### 12. Selective Targeting Through Chemical Remodeling of Protein Neosurfaces
...
### 13. Parameter Optimization and Smooth Adaptive Control of VSG-Based Grid-Connected Converters via MO-POACS
...
### 16. AutoSurrogate: An LLM-driven multi-agent framework for autonomous construction of deep learning surrogate models in subsurface flow
...
### 19. Multi-GraphDDI: Multi-Feature Fusion and Interaction for Graph-Based Drug-Drug Interaction Prediction.
...
### 20. Multi-Objective Numerical Design of Phase-Change-Material-Enabled Tunable Solar Management Structures
...
### 22. Physics-constrained machine-learning surrogates for the colebrook friction factor: monotonic gradient boosting, uncertainty quantification, and open benchmarking
...
### 23. Reconstructing sequence-grammar trajectories enables interpretable and tunable cis-regulatory element design
...
### 24. Optimal Design of Evaporation Performance for Evaporator Tubes Based on a Small-Sample Agent Model
...
### 25. Impact of zero‑output crisp range recentering on the performance of FPIDD2 controllers for multi-area LFC–AVR systems

**Authors:** Mohamed H. T. Omar, Ragi A. Hamdy, Hossam Kotb
**Date:** 2026-07-17
**Source:** openalex
**Link:** https://doi.org/10.1038/s41598-026-61334-8
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 27. When Can AI Models Explain Learning? Validity Criteria for AI as Cognitive Models in Education
...
### 28. Naphthalimide-functionalized alginate for danshensu delivery and selective fluorescence detection of nitrofurazone in vascular calcification
...
### 29. GW182 silencing domain engages the tristetraprolin-binding pocket of CNOT1 to recruit CNOT1 into multiprotein condensates

**Authors:** Bialobrzewski, M. K., Cieplak-Rotowska, M. K., Michas, A., Staszalek, Z., Sonenberg, N., Dadlez, M., Niedzwiecka, A.
**Date:** 2026-07-17
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/07/17/2026.07.16.738963.source.xml
**Code:** Not found
...
### 30. Benchmarking Classical, Hybrid, and Quantum Annealing Workflows on a Structured Control QUBO

**Authors:** Hamze Alavirad, Maryam Bahrami Zanjani
**Date:** 2026-07-17
**Source:** openalex
**Link:** https://doi.org/10.21203/rs.3.rs-10328048/v1
**Code:** Not found
**Tags:** stochastic_processes_probability_statistical_physics
**Priority hint:** Archive
**Paper type:** weak_match

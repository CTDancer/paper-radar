...
### 2. AI-enhanced virtual screening identifies a potent small-molecule modulator of ClC-3 for cervical cancer drug discovery
...
### 4. Spectral analysis and AI/ML-based data-driven approaches for enhanced protein conformation selection and prediction in drug discovery
...
### 5. AGDN: Learning to Solve Traveling Salesman Problem with Anisotropic Graph Diffusion Network
...
### 6. Evolution-inspired multi-objective Bayesian optimization for protein engineering
...
### 7. The Precision Tetrahedron: Loss Landscape Topology Across Number Formats and Multi-Target Drug Discovery
...
### 8. Unlocking Your Programmable and Creative RNA Sequence Designer with RDiffusion
...
### 9. AI-driven computational drug design: tools, workflow and challenges.
...
### 11. OTLesMix: Wasserstein Barycenter and Optimal Transport Map for Synthetic Lesion Generation with Diverse Shapes and Locations
...
### 12. From Uniform to Learned Graph Priors: Diffusion for Structure Discovery
...
### 13. PRISM: Distribution-Gated Flow Matching for Controllable Unpaired Image Translation
...
### 14. Ligand-based pharmacophore modeling for the discovery of NaV1.7 inhibitors
...
### 16. Multi-objective optimization of seismic upgrading interventions in existing RC buildings
...
### 18. SCOPE: Cost-Efficient Model Selection for Compound AI Systems under Quality Constraints
...
### 19. Design, Synthesis and Molecular Docking-Based Evaluation of Piperazine-Linked Triazine Derivatives as Antioxidant Agents
...
### 21. Beyond Holistic Models: Systematic Component-level Benchmarking of Deep Multivariate Time-Series Forecasting
...
### 22. RVQ-Alpha: Bridging Single-Cell Transcriptomics and Large Language Models via Hierarchical Discrete Tokenization and Fact-Aware Reinforcement Learning
...
### 23. Learning When to Trust via Selective Context Preference Optimization
...
### 24. $ω$-0: A Latent Predictive World Action Model for Concurrent Humanoid Loco-Manipulation
...
### 25. Scalable estimation of VARMA models
...
### 26. Hardware-validated hybrid super-twisting, fuzzy logic, and deep reinforcement learning framework for spacecraft attitude control
...
### 27. An integrated human forebrain organoid reveals microglia-mediated CD8⁺ T cell recruitment and neuroimmune dysfunction in Alzheimer's disease pathology
...
### 28. Depth-Guided Video Object Counting in Crowded Scenes
...
### 29. Schema-Grounded Multitask Instruction Fine-tuning for Joint Biomedical Named Entity Recognition and Relation Extraction in Pharmacovigilance
...
### 30. Charting the small-molecule universe from mass spectra with neuro-symbolic AI

**Authors:** Acikalin, U. U., Feng, D., Ferber, A. M., Gouveia, G. J., Schwertfeger, T. J., Chen, D., Qu, D., Fontaine, M. A.
**Date:** 2026-08-06
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/08/06/2026.08.05.743095.source.xml
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method

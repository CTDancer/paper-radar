...
### 19. SCOPE: Cost-Efficient Model Selection for Compound AI Systems under Quality Constraints
...
### 20. Design, Synthesis and Molecular Docking-Based Evaluation of Piperazine-Linked Triazine Derivatives as Antioxidant Agents
...
### 22. Beyond Holistic Models: Systematic Component-level Benchmarking of Deep Multivariate Time-Series Forecasting
...
### 23. RVQ-Alpha: Bridging Single-Cell Transcriptomics and Large Language Models via Hierarchical Discrete Tokenization and Fact-Aware Reinforcement Learning
...
### 24. Learning When to Trust via Selective Context Preference Optimization
...
### 26. Scalable estimation of VARMA models
...
### 27. Hardware-validated hybrid super-twisting, fuzzy logic, and deep reinforcement learning framework for spacecraft attitude control
...
### 28. An integrated human forebrain organoid reveals microglia-mediated CD8⁺ T cell recruitment and neuroimmune dysfunction in Alzheimer's disease pathology
...
### 29. Depth-Guided Video Object Counting in Crowded Scenes
...
### 30. Schema-Grounded Multitask Instruction Fine-tuning for Joint Biomedical Named Entity Recognition and Relation Extraction in Pharmacovigilance

**Authors:** Rehana, H., Hur, J.
**Date:** 2026-08-06
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/08/06/2026.07.30.741807.source.xml
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset

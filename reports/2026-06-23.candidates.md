...
### 2. DiFlow-TTS: Discrete Flow Matching with Factorized Speech Tokens for Low-Latency Zero-Shot Text-To-Speech

**Authors:** N. Nguyen, Hieu-Nghia Huynh-Nguyen, Thanh V. T. Tran, T. Hy, Van Nguyen
**Date:** 2025
**Source:** semantic_scholar
**Link:** https://www.semanticscholar.org/paper/e7a6717265dfb839741d0f500b1076a6ba8d2178
**Code:** Not found
...
### 4. Fast Multi-objective RNA Optimization with Autoregressive Reinforcement Learning
...
### 5. Probability of Antibiotic Resistance During Treatment in Stochastic PK/PD-Based Bacterial Model with Distinct Drug and Mutation Modes
...
### 6. Targeting the Mannitol Biosynthesis Pathway in Aspergillus fumigatus: Characterisation and Inhibition of Mannitol-2-Dehydrogenase
...
### 8. Defining reversible binding rates in 1D systems dependent on diffusion, density, and excluded volume
...
### 9. Continuous evolution of gene libraries towards arbitrary functions reveals the versatility of biomolecular evolution in vivo
...
### 10. Antibody-Antigen Affinity Prediction with Chain-Aware Protein Language Modeling
...
### 16. Generating antimicrobial peptides via genomic transfer learning
...
### 17. The shape of evolution: persistent homology of genetic-distancedata as an observable of reticulate processes in pathogen andplant genomes
...
### 18. Robust Conditional Diffusion with Noisy Templates for Antibody Sequence-Structure Design
...
### 19. Latent Terrain: Adapting Neural Audio Autoencoders as Design Materials in NIME
...
### 20. πDIA-CLIP: efficient identification of highly heterogeneous proteomics data via a generalized zero-shot framework
...
### 21. GENATATORs: ab initio Gene Annotation With DNA Language Models
...
### 22. Ecological axes of skull diversification in a massive 1 vertebrate radiation
...
### 23. SYNTHESIS AND ADSORPTION STUDY OF PENICILLIN G USING AN ACRYLAMIDE-EGDMA MOLECULARLY IMPRINTED POLYMER
...
### 24. Advances in functionalized biopolymers for targeted cancer drug delivery
...
### 25. Constrained assortment optimization under the mixed-logit model
...
### 26. From bench to bedside 2.0: AI-driven innovations in clinical research and&amp;nbsp;&lt;span style=&quot;font-size: 1rem;&quot;&gt;precision medicine&lt;/span&gt;
...
### 27. Protein-glass microenvironments define electron transfer vulnerability in Leigh syndrome
...
### 28. Applying Deep-Learning-Driven
...
### 29. The Ontological Status of AI-Generated Music: From Stylistic Mimicry to Collaborative Agency
...
### 30. From Known Relations to New One: Learning to Classify Triplets of Unseen Relations from A Biomedical Knowledge Graph

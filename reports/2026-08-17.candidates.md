...
### 2. A Computational Framework for Erythropoietin Protein Synthesis and Optimization: Integrating Protein Language Models, AlphaFold3 Structural Prediction, and Bayesian Optimization
...
### 3. Advancing cancer drug discovery through the integration of machine learning and high-throughput screening.
...
### 4. Vibrational power spectra as a tool to benchmark universal machine-learning interatomic potentials for molecular systems: the OMOL-1k-MD data set
...
### 6. Model Gateway: Management platform for model-driven drug discovery.
...
### 7. Generative AI-Assisted Discovery of HPK1 Inhibitors.
...
### 8. From data to decisions: how neural network input structures propagate to air quality policies
...
### 9. MLAC: MicroED-assisted ligand structure analysis in complexes and its application to hERG-ligand complexes
...
### 11. Research progress of diffusion model in crowd activity analysis
...
### 12. Transcranial ultrasound stimulation of the medial frontal cortex transiently improves performance by modulating conflict monitoring dynamics
...
### 13. GESTURE: Unsupervised Genotype-specific Behavioral Phenotyping in Rodents via Graph-based Representation Learning
...
### 14. Automated synthetic cell-based screening for designed proteins with emergent functions
...
### 15. Discovery and Optimization of a WRN Helicase Inhibitor Series through Structure-Guided Drug Design from a Covalent Fragment Binding Insight.
...
### 16. Parallel Heuristic Search as Inference for Actor-Critic Reinforcement Learning Models (Extended Abstract)
...
### 17. Cognitively-Inspired Two-Stage Diffusion Policy for Adaptive Resource Scheduling in Sustainable UAV-Assisted Mobile Edge Computing Systems
...
### 18. Safe and adaptive control of non-stationary stochastic systems via Lyapunov-constrained distributional reinforcement learning
...
### 19. Lattice random walk discretisations of stochastic differential equations
...
### 21. Petri Net Induced Heuristic Search for Resource Constrained Scheduling
...
### 22. Balancing fairness and efficiency in order allocation for quick-commerce applications
...
### 23. A dynamical circuit model for C. elegans chemotaxis with emergent sharp turns
...
### 24. Polynomial-Augmented Neural Networks (PANNs) with Weak Orthogonality Constraints for Enhanced Function and PDE Approximation
...
### 25. Optimization strategies for antimicrobial peptides in dental caries prevention and management: from emerging mechanisms of action to clinical translation
...
### 26. PepXPro: a framework for curating, generating, and optimizing structure-affinity protein-peptide datasets

**Authors:** L. America Chi, F. Marty Ytreberg
**Date:** 2026-08-14
**Source:** openalex
**Link:** https://doi.org/10.64898/2026.08.09.743757
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 30. Band-engineering in area-dependent InGaZnO(IGZO)-based memristive devices

**Authors:** Peijia Yuan, Clemens Wittberg, Jonas Deuermeier, Maria Elias Pereira, Yen-Po Liu, David N. Mueller, Asal Kiazadeh, Regina Dittmann
**Date:** 2026-08-14
**Source:** openalex
**Link:** https://doi.org/10.3389/fnano.2026.1870683
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method

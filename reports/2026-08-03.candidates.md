...
### 4. Integrating machine learning and molecular simulations for the design of potent HDAC2 inhibitors in diffuse large B-cell lymphoma.
...
### 6. Machine Learning–Driven Discovery of Dietary Polyphenol DPP-4 Inhibitors via Molecular Docking
...
### 7. Power system emulation for rapid exploration of water-energy policies
...
### 8. Discovery of potent ALK tyrosine kinase inhibitors for thyroid cancer via machine learning modeling, molecular docking, MD simulations, and DFT study.
...
### 9. Generation of antifungals to combat drug resistance using language models and diffusion models.
...
### 10. A Problem-Setup-Centric Framework for Mixed-Variable Chemical Formulation Optimization with Customized Constraints
...
### 11. Discovery of an NRAS isoform and activation-state selective macrocyclic peptide
...
### 12. Beyond Economic Efficiency: A Strategic Communication and Digital Governance Framework for Saudi Arabia’s Unified Health Insurance Reform toward Vision 2030
...
### 13. CoAff-DTI: Fine-grained drug-target interaction prediction using pre-trained language models and affinity-guided mechanisms.
...
### 14. Overcoming the data desert: generative AI techniques for synthesising anonymised deployment logs in regulated public sectors
...
### 16. Associative Memory and Generative Diffusion in the Zero-Noise Limit
...
### 19. Systematic modeling of phenotypic drug response profiles inpatient-derived organoids
...
### 20. Probabilistic surrogate modeling for gas foil bearing stability
...
### 21. PlumageParts: A fine-grained avian plumage segmentation dataset and benchmark for ecological image analysis
...
### 22. Prompting Beyond Pairs: Decoupled Semantic Supervision for Knowledge-Guided Multiplex Virtual Staining
...
### 23. Predicting Macroscopic Axon Topology from Microscopic Kinematics: An Interactive Tracking and Random Walk Pipeline for Substrate-Dependent Cortical Neurospheres
...
### 24. Gradient‐Free Online Learning of Subgrid‐Scale Dynamics With Neural Emulators
...
### 25. A workflow for residual stress control in laser powder bed fusion manufacturing
...
### 26. Genetic parser and deep residual bivariate Pascal-based energy-aware routing and scheduling for edge-enabled smart grids
...
### 27. FCD-11: A First-in-Class COMPASS Inhibitor in Cancer Therapeutics
...
### 28. Integrated computational and in vitro analysis reveals the toxic mechanisms of PFAS in female diminished ovarian reserve
...
### 29. Computational identification and characterization of high-risk human KRAS nsSNPs: Impacting structure, ligand binding, and cancer prognosis
...
### 30. An efficient motion planning framework for four-wheel steering autonomous vehicles using Lazy Edge-Based A* and adaptive RK4-MPC

# Paper Radar Candidates — 2026-08-20
...
### 2. Optimize Your Sampling: Tuned Diffusion Sampling with Bayesian Optimization

**Authors:** Travis Zhang, Christian Belardi, Justin Lovelace, Jin Peng Zhou, Saebyeol Shin, Carla P. Gomes, Kilian Q. Weinberger
**Date:** 2026-08-18
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.18040v1
**Code:** Not found
**Tags:** flow_matching_and_diffusion, optimization_methods, black_box_combinatorial_and_expensive_optimization
**Priority hint:** Must Read
**Paper type:** method
**Score:** 29.353
**Why selected:** Selected because it looks like a method paper connected to flow_matching_and_diffusion, optimization_methods, black_box_combinatorial_and_expensive_optimization.
**Possible concerns:** No obvious concern from metadata; still verify from the abstract.
...
### 4. Leveraging generative hallucination and biophysics-informed modeling for unified biomolecular sequence-structure co-design
...
### 5. Digital twin platform for accelerating optimization of oxide semiconductor transistors to overcome fundamental performance-reliability trade-off
...
### 6. ARTIFICIAL INTELLIGENCE-ASSISTED DRUG DESIGN COMBINED WITH MOLECULAR DOCKING FOR PRIORITIZATION OF POTENTIAL LEAD MOLECULES ACROSS FIVE THERAPEUTIC TARGETS

**Authors:** Harshveer Singh Jaitawat, Dr. C.S. Sharma, Dr. H.S. Udawat, P.S. Naruka
**Date:** 2026-08-17
**Source:** openalex
**Link:** https://doi.org/10.36713/epra28874
**Code:** Not found
...
### 9. Host immune network-guided reverse vaccinology approach for prioritizing candidate antigens in Schistosoma japonicum–associated liver fibrosis

**Authors:** Qianxu Yang, Jue Wang, Y. Ming, Yu Zhang, Li Ping Wong, Hai Yen Lee
**Date:** 2026-08-17
**Source:** openalex
**Link:** https://doi.org/10.1371/journal.pntd.0013519
**Code:** Not found
...
### 10. Non-local physics-informed neural networks for forward and inverse solutions of granular flows
...
### 11. Hybridized self adaptive memetic optimization for green cloud scheduling using cross domain adaptation

**Authors:** Raza Hasan, Salman Mahmood, Sellappan Palaniappan, Deborah Adedigba
**Date:** 2026-08-17
**Source:** openalex
**Link:** https://doi.org/10.1007/s44564-026-00005-2
**Code:** Not found
...
### 14. Initialization-Free Bundle Adjustment Revisited: A Controlled Experimental Study

**Authors:** Simon Weber, Mateo de Mayo, Je Hyeong Hong, Carl Olsson, Daniel Cremers, Ronald Clark
**Date:** 2026-08-18
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.18028v1
**Code:** https://github.com/simonwebertum/InitFreeBA.git
**Tags:** untagged
...
### 15. Thinking in a Low-Resource Language: What SFT Builds, What RL Fixes, What Accuracy Cannot See

**Authors:** Ayoub Kirouane, Christos Petrocheilos
**Date:** 2026-08-18
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.17744v1
**Code:** Not found
...
### 17. Unmasking conversational bias in AI multiagent systems
...
### 18. Unsupervised Learning of Cell Instances with Generative Routing Pyramids
...
### 19. The next evolution of theranostics: from target discovery to integrated precision medicine
...
### 20. Laboratoires autonomes multi-agents
...
### 21. PertMind: Eliciting Emergent Biological Reasoning in LLM via Reinforcement Learning on Cellular Perturbation Data
...
### 22. A hybrid grey Wolf–arithmetic optimization algorithm for high-accuracy parameter identification of photovoltaic models
...
### 23. Immunoinformatics-based design and in silico evaluation of a PstS-derived multi-epitope vaccine candidate against Salmonella typhimurium
...
### 24. Plug-and-Play Traffic Element Awareness for End-to-End Autonomous Driving

**Authors:** Zongzheng Zhang, Jijun Wang, Saining Zhang, Shuo Wang, Yiru Wang, Hai Yang, Yang Chen, Yuwen Heng
**Date:** 2026-08-18
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.18035v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 25. Quantum Geometric Tensor Preconditioning for Stable Training of Recurrent Neural Quantum States
...
### 26. EDITBRIDGE: Towards Faithful and Efficient Ultra-High-Resolution Image Editing

**Authors:** Jiayi Song, Shijie Huang, Fangtai Wu, Yubo Huang, Zhenxiong Tan, Songhua Liu, Jiaming Liu, Ruihua Huang
**Date:** 2026-08-18
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.18063v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 27. Harnessing Magnitude-Only and Complex Measurements for Improved Dynamic MRI Reconstruction with Learned Priors

**Authors:** Mahdi Saberi, Yaşar Utku Alçalar, Merve Gülle, Chetan Shenoy, Mehmet Akçakaya
**Date:** 2026-08-18
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.18036v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 28. Engineered strains as living factories: efficient biosynthesis and modification of natural products via synthetic biology and one-pot chemical tandem reactions
...
### 29. mlip-dynamic-stability: a finite-temperature dynamic-stability benchmark of foundation MLIPs
...
### 30. Combining Evolutionary Optimization and Deep Learning for Inverse Mathematical Problems

**Authors:** Vasuk M., Anjay Kumar Mishra, Dinesh Kumar, Mbonigaba Celestin, Osman Mohamed Hassan, Lloyd Zulu
**Date:** 2026-08-17
**Source:** openalex
**Link:** https://doi.org/10.3126/ppe.v1i1.98692
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset

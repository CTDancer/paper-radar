...
### 7. Integrating machine learning and molecular simulations for the design of potent HDAC2 inhibitors in diffuse large B-cell lymphoma.
...
### 8. Can Artificial intelligence meaningfully shorten drug discovery timelines? Current evidence, roadblocks and future directions.
...
### 9. CENO: A Genome-Scale World Model for Evolutionary Sequence Interpretation and Programmable Regulatory Design
...
### 10. Proteomic Profiling Identifies CLDN3 as a Tumor-Selective Therapeutic Target in Small Cell Lung Cancer
...
### 11. Evaluation of Multi-Scenario Distribution Network Planning Based on Bayesian Optimization of Heterogeneous Stacked Ensemble Learning
...
### 13. Enhanced Wolpertinger architecture for solving optimal control problems of reconfigurable battery systems
...
### 14. LNMGAT: a laplacian regularized pseudo-negative mining graph attention network for robust drug–target interaction prediction under multi-scenario cold-start settings
...
### 15. Exploring the use of Cyrene for the amidation of E3 ligase recruiters: efficient access to PROTAC precursors
...
### 16. Discovery of potent ALK tyrosine kinase inhibitors for thyroid cancer via machine learning modeling, molecular docking, MD simulations, and DFT study.
...
### 18. CoAff-DTI: Fine-grained drug-target interaction prediction using pre-trained language models and affinity-guided mechanisms.
...
### 19. Machine learning-accelerated inverse design of energy materials: A critical review of graph neural networks, physics-informed models, and generative AI for batteries, perovskite solar cells, and electrocatalysts
...
### 20. Analysis of building energy efficiency optimization design effectiveness based on multi-objective optimization algorithm
...
### 21. $β$-OPSD: Deriving with Policy Optimization, Training with Self-Distillation
...
### 22. OSReward: Instituting Standardized Evaluation for Cross-Platform Computer-Use Reward Models
...
### 25. On-Policy and Off-Policy Learning for Large Action Spaces
...
### 27. A manufacturability-informed topology framework for AI-guided design of fibrous network materials
...
### 29. In Silico to In Cerebro—Development of the Orexin Receptor Antagonist “Photorexant” for Photomodulation In Vitro and in Mouse Brains
...
### 30. The Human Bindome: A Proteome-scale Atlas of Designed Binder Candidates

...
### 3. How Bias Shapes the Leaderboard: Scoring Function Performance Under Scrutiny
...
### 4. Beyond Generic Signal Peptides: ApexSP Enables Cargo-Specific Secretion Design
...
### 5. Structure-free, site-resolved contrastive learningextends small-molecule discovery beyond the reachof structure-based modeling
...
### 6. Can Artificial intelligence meaningfully shorten drug discovery timelines? Current evidence, roadblocks and future directions.
...
### 27. Quantifying per-match Reliability in Library Matching for Untargeted Metabolomics Workflows

**Authors:** Charria-Giron, E., van IJcken, J., Della Vedova, L., Torres-Ortega, L. R., van der Hooft, J. J. J.
**Date:** 2026-07-30
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/07/30/2026.07.30.741704.source.xml
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 29. Computational Modeling of Functionalized Graphene Quantum Dots Binding to Tau Fibrils in Alzheimers Disease
...
### 30. Benchmarking and developing large language models using one million clinical trials

# Paper Radar Candidates — 2026-08-28
...
- Raw candidates: 214
- Deduplicated candidates: 140
- Candidate count: 30

## Candidates

### 1. GFlowNet.jl: A Julia Framework for Generative Flow Networks

**Authors:** Tianchi Chen
**Date:** 2026-08-26
**Source:** openalex
**Link:** https://doi.org/10.5281/zenodo.22117533
**Code:** Not found
**Tags:** generative_modeling_core, flow_matching_and_diffusion, optimization_methods, ai_drug_discovery, gflownet_related_methods, black_box_combinatorial_and_expensive_optimization
**Priority hint:** Must Read
**Paper type:** method
**Score:** 32.528
**Why selected:** Selected because it looks like a method paper connected to generative_modeling_core, flow_matching_and_diffusion, optimization_methods, ai_drug_discovery.
**Possible concerns:** No obvious concern from metadata; still verify from the abstract.

**Abstract:** GFlowNet.jl is a Julia implementation of Generative Flow Networks (GFlowNets), a class of generative models that learn to sample compositional objects with probability proportional to a reward function. The package provides multiple training objectives (Trajectory Balance, Detailed Balance, Flow Matching, Sub-Trajectory Balance, Direct Flow), a domain-adapter architecture for applying GFlowNets to new problem spaces, and applications spanning grid worlds, molecular design, and combinatorial optimization.

### 2. MolGraphGAN: a graph transformer–adversarial framework for target-specific molecule generation

**Authors:** Abdelrahman Hussein, Vikram V. Patel, Sudeep Varshney, T. Narmadha, Adam Amril Jaharadak, M. D. Anto Praveena, Prabhat Kumar Sahu, Vikas Wasson
**Date:** 2026-08-26
**Source:** openalex+pubmed+europe_pmc
**Link:** https://doi.org/10.1007/s10822-026-00920-4
**Code:** Not found
...
### 3. Mechanistic Reaction Prediction via Discrete Flow Matching on Graph-Structured Electron Occupation
...
### 4. Optimal-transport flow matching for stochastic model ipdating
...
### 5. AI-powered medicinal chemistry and translational drug development.
...
### 6. GRAS: Guided Reduced-Variance Proposals and Adaptive Selection for Training-Free Reward Alignment in Discrete Diffusion
...
### 7. LFD (v1.0): latent-compression-free generative diffusion with geological priors and geophysical regularization for implicit structural modeling

**Authors:** Zhixiang Guo, Xinming Wu, Yimin Dou, Hui Gao, Guillaume Caumon
**Date:** 2026-08-26
**Source:** openalex
**Link:** https://doi.org/10.5194/gmd-19-7961-2026
**Code:** Not found
...
### 8. How do flow matching models memorize and generalize in sample data subspaces
...
### 10. From Days to Hours: Artificial Intelligence in Antimicrobial Resistance Diagnostics and Drug Discovery, and Why No Tool Has Yet Reached the Clinic

**Authors:** Drug Discovery
**Date:** 2026-08-25
**Source:** openalex
**Link:** https://doi.org/10.25163/biomedical.10110890
**Code:** Not found
...
**Abstract:** Background: Antimicrobial resistance (AMR) is projected to contribute to millions of deaths in the coming decades, and the conventional antibiotic-discovery pipeline has, by most accounts, not kept pace with it. Artificial intelligence (AI) is frequently proposed as a corrective, though whether that promise has translated into demonstrable clinical benefit is less often examined directly. Methods: We conducted a narrative-systematic review of peer-reviewed and preprint literature on AI applications in AMR diagnostics and antimicrobial discovery, searching PubMed/MEDLINE, Scopus, Web of Science, and the Cochrane Library through mid-2026, and organized findings across four domains: rapid phenotypic diagnostics, genomic and metagenomic resistome prediction, explainable AI, and de novo drug design. Results: AI-enabled diagnostics reduced susceptibility-testing turnaround from a conventional 36–72 hours to under 2–4 hours in several platforms; genomic language models such as DNABERT outperformed conventional classifiers by 12–18% in resistance-gene classification; explainable AI methods, SHAP in particular, linked model predictions to known resistance mechanisms; and generative frameworks yielded antimicrobial peptide candidates with confirmed in vitro and in vivo activity. Nearly all of this evidence, however, derives from retrospective, single-center validation, and no AI-based AMR tool has yet secured regulatory clearance anywhere. Conclusion: AI has moved convincingly beyond proof-of-concept in AMR diagnostics and discovery, but its path to the clinic now depends less on further algorithmic refinement than on prospective validation, equitable data representation, and interpretability standards that clinicians can reasonably trust.

### 11. A Scalable and Resource‐Efficient Pipelined p‐Computer for Probabilistic Ising Machines

**Authors:** Deborah Volpe, Eleonora Raimondo, Andrea Grimaldi, Pedram Khalili Amiri, Stefano Chiappini, Anna Giordano, Mario Carpentieri, Hyunsoo Yang
**Date:** 2026-08-25
**Source:** openalex
**Link:** https://doi.org/10.1002/aisy.70521
**Code:** Not found
...
**Date:** 2026-08-26
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.26419v1
**Code:** Not found
...
### 14. Targeting IDH-driven Oncometabolism in glioblastoma: a computational approach for the identification of potential inhibitors

**Authors:** Nivedhitha Tamilazhagan, Sivakumar Arumugam
**Date:** 2026-08-26
**Source:** openalex
**Link:** https://doi.org/10.3389/fbinf.2026.1884553
**Code:** Not found
...
### 17. TTPO: Test-Time Policy Optimization
...
### 18. Encoder-free hexapod dead reckoning on sand using learned inertial correction

**Authors:** Mingyu Pan, Maxwell A. Rollins, Samuel H. Yang, Kathryn A. Daltorio
**Date:** 2026-08-26
**Source:** openalex
**Link:** https://doi.org/10.3389/frobt.2026.1920986
**Code:** Not found
...
### 21. Elucidating adverse drug reactions and underlying molecular mechanisms of ivermectin through pharmacovigilance and multi-omics analysis

**Authors:** Boyi Liu, Xiaoze Chen, Yishuo Wang, Hao Zhang, Xiao Liang, Xin Guan, W Zhang, Ao Han
**Date:** 2026-08-26
**Source:** openalex
**Link:** https://doi.org/10.3389/fcimb.2026.1938550
**Code:** Not found
...
### 24. SPOP-mediated ZMYND8 ubiquitination and phase separation exclusion drives mTOR inhibitor resistance in kidney cancer

**Authors:** Bo Tang, Rui Sun, Jingwei Shao, Qiyou Wu, Yuqian Yan, Dejie Wang, Zhixian Yu, Lianxin Hu
**Date:** 2026-08-25
**Source:** openalex
**Link:** https://doi.org/10.1038/s41467-026-77043-9
**Code:** Not found
...
### 27. Physics-informed adversarial networks for stochastic second-order mean-field games of autonomous traffic
...
### 28. Active Diffusion-Based Inference for Ill-Posed Inverse Problems under Incomplete Priors

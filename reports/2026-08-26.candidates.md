...
### 1. AI-powered medicinal chemistry and translational drug development.
...
### 3. Beyond the flat screen: evaluating virtual reality as a complementary tool for molecular docking in drug discovery.
...
### 4. A cell-based degrader assessment platform facilitates discovery of functional NUDT5 PROTACs
...
### 6. Molecular size dominates α2-adrenergic subtype-selectivity benchmarks: five controls for reducing attrition in selective ligand design
...
### 7. Proteome-Scale Mining and Multi-Objective Prioritization of Encrypted Antimicrobial Peptides with Experimental Validation
...
### 8. Primal--Dual Alternating Neural Learning for Timely Classification with Performance Guarantees
...
### 9. Time-resolved operator archetypes characterize dynamical sensitivity during cell-state transitions
...
### 10. FixAnything: 3D-Consistent Rendering Refinement via Video Generative Priors
...
### 12. Action-Aligned Retrieval with Pairwise Multimodal Reranking for Text-Based Person Anomaly Search
...
### 13. Functional Pairing of TCR-peptide-MHC Interactomes by Single-cell Clonal Expansion
...
### 14. A general-purpose sensitivity method for multiple simultaneous parameter perturbations in stochastic reaction networks

**Authors:** David F. Anderson, Jingyi Ma
**Date:** 2026-08-23
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.22627v1
**Code:** Not found
...
### 15. Formation of an RNA-mediated nuclear compartment

**Authors:** Lafontaine, D. L., Calvo-Roitberg, E., Chung, Y.-C., Yang, L., Wise, N., Tu, L.-C., Pai, A. A., Dekker, J.
**Date:** 2026-08-23
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/08/23/2026.08.20.746005.source.xml
**Code:** Not found
**Tags:** molecular_glue_and_tpd
**Priority hint:** Archive
**Paper type:** method
...
### 17. Mountain Centroid: RNA Ensemble Representation with Mountain Profiles

**Authors:** Otagaki, T., Asai, K., Sato, K.
**Date:** 2026-08-23
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/08/23/2026.08.19.745640.source.xml
**Code:** Not found
...
### 18. Inertial Manifold Neural Operator for Dissipative Time-Dependent Partial Differential Equations

**Authors:** Xiaoyang Xie, Clarence W. Rowley
**Date:** 2026-08-24
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.23546v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 19. Geometry-Driven Opti-Acoustic Co-Registration and View-Invariant Reflectivity Mapping for Side-Scan Sonar
...
### 20. Interpretable AI with Local Distillation

**Authors:** Erin Craig, Yiling Huang, Snigdha Panigrahi
**Date:** 2026-08-24
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.23538v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 21. OPTIMIZING PRE-PROCESSING OF NEAR INFRARED SPECTRA FOR PHENOMIC PREDICTION USING SINGULAR VALUE DECOMPOSITION

**Authors:** Bienvenu, C., Roger, J.-M., Sene, M., Castro Pacheco, S. A., Singer, M., Felaniaina, B. L., Terrier, N., De Bellis, F.
**Date:** 2026-08-23
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/08/23/2026.05.10.724118.source.xml
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 22. Chimera: Efficient Multi-Vector Retrieval via GPU-CPU Co-Processing

**Authors:** Yanqi Chen, Juelin Liu, Alexandra Meliou, Xiao Yan
**Date:** 2026-08-24
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.23553v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 23. Physics-Constrained Deep Learning Model for Contactless Blood Pressure Monitoring from Triaxial Bodyseismography
...
### 24. EG-ARSA: An Expert-Grounded Open Model for Visual Road Safety Auditing in Low-Resource Settings

**Authors:** Md Thamed Bin Zaman Chowdhury, Moazzem Hossain
**Date:** 2026-08-24
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.23563v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 25. Bayesian Network Structure Learning: The NewCalibrated Minimum Uncertainty Criterion andDiscriminative Power Evaluation Framework

**Authors:** Gogoshin, G., RODIN, A. S.
**Date:** 2026-08-23
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/08/23/2025.10.13.681946.source.xml
**Code:** Not found
**Tags:** generative_modeling_core
**Priority hint:** Archive
...
### 27. InterPET: A Curated Benchmark of Sequence Embeddings and Graph Architectures with Interpretability and Biological Validation for PETase Activity Prediction

**Authors:** Handrian, C., Prakoso, I.
**Date:** 2026-08-23
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/08/23/2026.08.18.745360.source.xml
**Code:** https://github.com/indiraprakoso/interpet/
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
**Score:** 1.384
...
### 28. Robustness of Anomaly Detection Models for Industrial Control Systems under Training-Time Data Contamination

**Authors:** Mustafa Umut Ozbek, Taiwo Ojo, Pooria Madani, Khalil El-Khatib, Li Yang
**Date:** 2026-08-24
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.23547v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 29. Sparse autoencoder features from InterPLM predict neuropeptide precursors among secreted proteins

**Authors:** Kulikova, A. V., Bookout, A. L., Koch, T. L., Safavi-Hemami, H.
**Date:** 2026-08-23
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/08/23/2026.08.20.746077.source.xml
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method

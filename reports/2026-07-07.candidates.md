...
### 2. ADMET Property Prediction with Quantum-Inspired Preprocessing
...
### 3. Tetrapeptide inhibitors of BACE-1 revealed by combined data-driven screening and physics-based free-energy refinement.
...
### 10. Optimal Pre-Experimental Coil Sequence Selection for TMS Motor Mapping
...
### 11. Machine learning-guided discovery of spirocyclic inhibitors targeting Mycobacterium tuberculosis FtsZ.
...
### 12. TCR-FramePose: a local-frame representation for decomposing global docking and CDR3 loop geometry in TCR-pMHC recognition
...
### 13. A Bottom-Up Platform for Quantitative Single-Molecule Tracking Through Bacterial Biofilm Mimics
...
### 14. CryoROLE: describing large inter-domain rotation in single particle cryo-EM
...
### 15. FoxO3a and miR-34a-3p Are Involved in Oxidative Stress-Induced Dysfunction of Human Endothelial Progenitor Cells
...
### 16. Unbalanced Perturbation Dynamics For Cell Fate Design
...
### 17. Computationally mapping olfactory receptors to odor percepts using docking energy scores
...
### 27. Connectome quality converges predictably to reveal optimal stopping points during proofreading
...
### 28. SPICE: A Robust Computational Framework for Identifying Copy Number Variations in Spatial Transcriptomics
...
### 29. La diffusion des outils et services e-santé auprès de leurs utilisateurs : l’exemple de « Mon espace santé » en France
...
### 30. Structure-guided discovery of a potent 2-aryl-4-aminoquinazoline-based inhibitor overcoming osimertinib resistance driven by EGFR C797S mutation in NSCLC.

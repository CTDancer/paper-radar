# Paper Radar Candidates — 2026-07-12
...
### 4. Breaking the Bottleneck of New Drug Screening... Innovation in Protein-Ligand Dissociation Kinetics (k_off) Prediction with Qua
...
### 9. Statistical Efficiency and Inference of Quantile Distributional Reinforcement Learning
...
### 10. Integrated network toxicology, bioinformatics, and molecular docking reveal the potential molecular mechanisms linking bisphenol A to glioma progression

**Authors:** Lei Miao, Fengwei Hou
**Date:** 2026-07-10
**Source:** openalex
**Link:** https://doi.org/10.3389/fbinf.2026.1857455
**Code:** Not found
...
### 12. A Bayesian-evolutionary framework for the full-parameter topology screening and global optimization of PEMFC thermal systems

**Authors:** Q F Liu, Yongyi Dou, Jiaxuan Li, Jiakun Si, Puze Yang, Qingfeng Tang, Qi Li, Pei Fu
**Date:** 2026-07-10
**Source:** openalex
**Link:** https://doi.org/10.1016/j.fuel.2026.140592
**Code:** Not found
...
### 16. Bayesian Experimental Design via Score Matching
...
### 17. LongE2V: Long-Horizon Event-based Video Reconstruction, Prediction, and Frame Interpolation with Video Diffusion Models
...
### 19. Mapping Active-Site Conformational Ensembles Along Competing Catalytic Pathways of the Hairpin Ribozyme

**Authors:** Forget, S., Stirnemann, G.
**Date:** 2026-07-09
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/07/09/2026.03.12.711346.source.xml
**Code:** Not found
...
### 21. Learning Adaptive Solvers for Distributed Factor Graph Optimization on Matrix Lie Groups
...
### 23. AutoAnchor: Stable Diffusion Unlearning Using Cross-Attention as a Manifold Surrogate
...
### 27. Latent Memory Palace: Reasoning for Control as Autoregressive Variational Inference
...
### 28. Progress in structure prediction and design of adaptive immune receptors

**Authors:** Tomer Cohen, Tanya Hochner, Dina Schneidman‐Duhovny
**Date:** 2026-07-10
**Source:** openalex
**Link:** https://doi.org/10.1016/j.sbi.2026.103326
**Code:** Not found
**Tags:** protein_design
**Priority hint:** Archive
**Paper type:** review
...
### 30. Temporal Fusion Transformer Surrogate Modeling of Chloride-Induced Corrosion Initiation Probability in Reinforced Concrete Bridge Infrastructure

**Authors:** Wei Zheng, Yuzhong Huang
**Date:** 2026-07-10
**Source:** openalex
**Link:** https://doi.org/10.70465/ber.v3i3.94
**Code:** Not found

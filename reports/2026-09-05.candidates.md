...
### 5. CROWN: Curated Repository Of Well-resolved Noncovalent interactions
...
### 6. Configuration-space Bayesian optimisation for stress-critical pose identification on a hyper-redundant robot
...
### 7. DESPOT: Direction-Enhanced Scoring POTentials
...
### 8. Convergence of cryo-electron microscopy and artificial intelligence in integrative structural biology: A critical review of advances, synergies, and implications for molecular biophysics and drug discovery.
...
### 9. Advancing cancer drug discovery through the integration of machine learning and high-throughput screening.
...
### 10. A Reference Landscape of Regulatory T Cell States in Mice
...
### 11. Non-standard proteins in the lens of AlphaFold 3: a case study of amyloids
...
### 13. From PROTACs to Clinical Reality: A Narrative Review of Targeted Protein Degradation Therapies
...
### 14. Sequence-free landscape inference for directed evolution
...
### 15. Bayesian Descriptions are not Mechanisms: Predictive Processing and the Realisation Gap in Embodied Neural Dynamics
...
### 16. Evolving transition-state search with agentic large language models
...
### 17. OT-knn: a neighborhood-aware optimal transport framework for aligning spatial transcriptomics data
...
### 18. HSSynergy: scale-aware hierarchical attention for interpretable drug synergy prediction
...
### 19. A curated benchmark for cofolding models on kinase conformational states
...
### 20. TokenMatch: 3D Mesh Correspondence Transformer with Curvature-Guided Tokenisation
...
### 22. Machine Learning-Assisted Optimization of CMOS VLSI Circuits for Low-Power and High-Speed Applications
...
### 23. Iterated Agent for Symbolic Regression
...
### 25. Robust PAC Learning of Concurrent Stochastic Games
...
### 26. Molecules to market: A probabilistic artificial intelligence framework for predicting managed care adoption at the level of drug discovery.
...
### 27. Q-Edge: Symmetry-Reduced Quantum Simulation of Structured Extreme Dependence
...
### 28. New thinking for the next generation of antimalarials
...
### 29. ESPO: Error-Structured Prompt Optimization via Diagnose, Diversify, and Stabilize
...
### 30. High-Throughput Screening Identifies Small-Molecule Inhibitors of the Tau-LRP1 Interaction

**Authors:** Wang, C., Ma, C.-T., Crotty, C., Zeng, F.-Y., Bobkov, A., Covel, J. A., Keane Rivera, E., Sergienko, E.
**Date:** 2026-09-02
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/09/02/2026.06.24.733881.source.xml
**Code:** Not found

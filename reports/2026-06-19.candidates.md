...
- Raw candidates: 336
- Deduplicated candidates: 223
- Candidate count: 30

## Candidates

### 1. A Human-in-the-Loop Bayesian Optimization Framework for Constraint-Aware Bioprocess Development
...
**Date:** 2026-06-17
**Source:** arxiv
**Link:** http://arxiv.org/abs/2606.19230v1
**Code:** Not found
**Tags:** optimization_methods, multi_objective_optimization, black_box_combinatorial_and_expensive_optimization, graph_algorithms_and_discrete_structures
**Priority hint:** Strong Skim
**Paper type:** method
**Score:** 24.442
**Why selected:** Selected because it looks like a method paper connected to optimization_methods, multi_objective_optimization, black_box_combinatorial_and_expensive_optimization, graph_algorithms_and_discrete_structures.
...
### 3. chyiricketts/Target-Specific_BAP_Prediction: Target-Specific BAP Predictions v1.0: Protein–Ligand Binding Affinity Prediction Pipeline
...
### 4. RareFold: Structure prediction and design of proteins with noncanonical amino acids
...
### 6. Optimal score function estimation via derivatives constraints
...
### 7. Perron--Frobenius Operator Matching for Generative Modeling
...
### 8. Machine learning-assisted high-speed combinatorial optimization with Ising machines for dynamically changing problems
...
### 10. Nano-TPD for precision protein degradation via endogenous or exogenous triggered release
...
### 12. ORACLE : Online reinforcement‐driven adaptive constraint learning engine for nonlinear optimization
...
### 14. UBP2: Uncertainty-Balanced Preference Planning for Efficient Preference-based Reinforcement Learning
...
### 16. In Silico Comparison of AI-Generated Pharmacophore Analogs Against Mycobacterium tuberculosis Target Proteins with Traditional Finding of Analogs for Molecular Docking Approaches
...
### 19. Rethinking Reward Supervision: Rubric-Conditioned Self-Distillation
...
### 20. P-K-GCN: Physics-augmented Koopman-enhanced Graph Convolutional Network for Deep Spatiotemporal Super-resolution

**Authors:** Xizhuo, Zhang, Zekai Wang, Fei Liu, Bing Yao
**Date:** 2026-06-17
**Source:** arxiv
**Link:** http://arxiv.org/abs/2606.19303v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 22. Diffusion-Proof: Recipe for Formal Theorem Proving Beyond Auto-Regressive Generation
...
### 23. Formulation of hispidulin-loaded sodium carboxymethyl cellulose nanoparticles: characterisation, biological activities and molecular insights
...
### 24. Contextualizing Biological Language Models across Modalities via Logit-Space Contrastive Alignment
...
### 25. Native Active Perception as Reasoning for Omni-Modal Understanding
...
### 26. MOLAR: Learning Multimodal Molecular Representations from Noisy Labels

**Authors:** Yingxu Wang, Kunyu Zhang, Nan Yin, Yu Li, Eran Segal
**Date:** 2026-06-16
**Source:** arxiv
**Link:** http://arxiv.org/abs/2606.18390v1
**Code:** Not found
...
### 27. Prediction of pre- and postfusion conformations of class I fusion proteins with AlphaFold2.
...
### 28. Machine learning application in molecular science research field
...
### 29. Expanding gene regulatory networks from transcriptome data through graphical modeling with heterogeneous priors
...
### 30. NeuMesh++: Towards Versatile and Efficient Volumetric Editing with Disentangled Neural Mesh-based Implicit Field

...
**Authors:** Jiajun Liang, Yucheng Liao, Yukang Cao, Jiazhe Wei, Ken Li, Wende Tan, Jiankun Zhang, ZY Cui
**Date:** 2026-08-03
**Source:** arxiv
...
### 3. Artificial intelligence: Catalyzing a new era in pancreatic cancer cure.
...
### 4. From generation to validation: Deep generative models for antimicrobial peptide discovery.
...
### 8. A Unified Kullback--Leibler Divergence Analysis of Generative Diffusion Models via Entropy Production Rate

**Authors:** Han Wu, Zhiwen Zhang
**Date:** 2026-08-03
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.02406v1
**Code:** Not found
...
### 9. AtumAI: A Principled Framework for Agentic Generation of Datacenter Control-Plane Policies

**Authors:** Qiushi Lin, Chaojie Zhang, Íñigo Goiri, Aditya Akella, Ricardo Bianchini, Jovan Stojkovic
**Date:** 2026-08-03
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.02569v1
**Code:** Not found
**Tags:** flow_matching_and_diffusion, black_box_combinatorial_and_expensive_optimization
**Priority hint:** Must Read
**Paper type:** method
**Score:** 20.451
**Why selected:** Selected because it looks like a method paper connected to flow_matching_and_diffusion, black_box_combinatorial_and_expensive_optimization.
**Possible concerns:** No obvious concern from metadata; still verify from the abstract.
...
### 10. PG-MLD: Physics-Guided Molecular Representation Learning via Dynamic 3D Trajectory Distillation
...
### 12. Computational and Statistical Guarantees of the \textit{c}-Rectified flow
...
### 13. Elucidating enzyme-substrate specificity through co-folding foundation model
...
### 14. Fermat Active Laplace Learning for Semi-Supervised Hyperspectral Image Classification

**Authors:** Vutichart Buranasiri, James M. Murphy
**Date:** 2026-08-03
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.02483v1
**Code:** Not found
...
### 15. AI-Driven Digital Twin Framework for Multi-Objective Optimization of Hybrid Cooling Channels in Intelligent Mechanical Systems
...
### 16. Bayesian equivariant interatomic potential with iterative restratification of many-body message passing
...
### 17. Sandaracopimaric acid against the MAO-B/LRRK2 axis in Parkinson’s disease
...
### 18. Interpretable Machine Learning Model of Receptor Dynamics Reveals AT1R Allostery and a Negative Allosteric Modulator
...
### 19. Automatic design of convolutional neural network architectures using multi-objective metaheuristics for classification of medical databases
...
### 20. Generation of antifungals to combat drug resistance using language models and diffusion models.
...
### 21. Benchmarking Deep Learning Predictions of Mutation-Induced Fold Switching
...
**Date:** 2026-08-03
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.02575v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Skim
**Paper type:** method
...
### 24. onepot-Bench 0: towards lab-aware in silico chemistry benchmarks

**Authors:** Brandon Wang, Andrei S. Tyrin, Daniil A. Boiko
**Date:** 2026-08-03
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.02595v1
**Code:** Not found
...
### 28. Fast Solution Methods for the Classical 0–1 Knapsack Problem
...
### 29. Benchmarking Sheaf Neural Networks for Inductive Tasks

**Authors:** Stefano Fiorini, Edoardo Coppola, Pietro Liò
**Date:** 2026-08-03
**Source:** arxiv
**Link:** http://arxiv.org/abs/2608.02558v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** benchmark_dataset
...
### 30. PG-LLM: Benchmarking General-Purpose Language Models for Protein Variant Ranking

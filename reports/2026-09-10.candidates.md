...
### 6. A landscape-aware multi-objective ant colony optimization framework for urban waste collection vehicle routing
...
### 7. Quantum WTA: Deterministic Sanation Contour for Quantum Processors — An Architectural Hypothesis Based on Windowed Thermodynamic Approximation (WTA)
...
### 8. Mask Forcing: Improving Autoregressive Video Diffusion Distillation via Dual-Noise Masking Rollout
...
### 9. High-Magnetization Sampling at Low Temperatures: Ising Models and Bayesian Sparse Linear Regression
...
### 10. The Accuracy Paradox: Empirical Diagnostic of Default Decision Thresholds in Multi-Label Enzyme Commission Prediction [With Code]

**Authors:** Bilal Ahmad, Rajed Mehmood
**Date:** 2026-09-07
**Source:** arxiv
**Link:** http://arxiv.org/abs/2609.07897v1
**Code:** Not found
...
### 11. ReCite: Agentic Reasoning for Faithful Citation
...
### 17. PharmCast: rapid generation of three-dimensional pharmacophore fingerprints from two-dimensional structure without conformer generation
...
### 18. Entropy-Regularized Rank-Masked Policy Optimization for Test-Time Reinforcement Learning in Code Generation
...
### 20. Proxy Policy Steering

**Authors:** Chuanruo Ning, Tianrui Wang, Wei-Chiu Ma, Kuan Fang
**Date:** 2026-09-08
**Source:** arxiv
**Link:** http://arxiv.org/abs/2609.09148v1
**Code:** Not found
**Tags:** untagged
**Priority hint:** Archive
**Paper type:** method
...
### 23. ExecCritic: Learn to Test, Test to Improve for Coding Agents
...
### 24. Learning Universal Representations of Intermolecular Interactions with ATOMICA
...
### 25. Gradient-based versus gradient-free optimization in hybrid quantum machine learning: a systematic benchmark
...
### 26. Motif-based model of transcription predicts effects of sequence variants in AR enhancers and reveals distinct functions for AR-associated transcription factors
...
### 27. Architectural good practices for reproducible benchmarking in protein machine learning
...
### 28. Transformers as In-Context Samplers: From Closed-Form Diffusion to Estimation-Free Sampling
...
### 29. 100,599 unique viable up/down-exclusive two-flavon Froggatt-Nielsen models obtained from a multi-objective genetic algorithm scan
...
### 30. SAEScientist-Bench: Can AI Agents Conduct Autonomous SAE Interpretability Research?

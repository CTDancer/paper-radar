...
### 20. From data to scent: validating an ensemble AI model that predicts novel insect odourant interactions.
...
### 21. Structural Snapshots of B12-Dependent Methionine Synthase's Catalytic Conformations

**Authors:** Mendoza, J., Yamada, K., Castillo, C., Greenwood, V., Pramanik, S., Salampuriya, R., Wilhelm, C. A., Koutmos, M.
**Date:** 2026-07-19
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/07/19/2024.08.29.610163.source.xml
**Code:** Not found
**Tags:** computational_chemistry_biophysics_structural_biology
**Priority hint:** Archive
**Paper type:** application
...
### 23. Charged amino acid propensities and solubility: lysine is elevated at the termini of helices in E. coli proteins.

**Authors:** Zhang, S., Warwicker, J.
**Date:** 2026-07-19
**Source:** biorxiv
**Link:** https://www.biorxiv.org/content/early/2026/07/19/2026.07.13.738247.source.xml
**Code:** Not found
**Tags:** protein_design
**Priority hint:** Archive
**Paper type:** application
...
### 25. Learning to read a second language establishes a parallel L2 representation alongside the native one in the VWFA
...
### 26. InsectDCT: A generalized pipeline for detection, taxonomic classification, and tracking of insects in camera-trap recordings
...
### 27. Whole-genome resequencing identified loci underwent divergent selection and improved local adaptability in groundnut (Arachis hypogaea)
...
### 28. A Beta-Binomial Model for Estimating Zero- or One-inflated Pain Trajectories
...
### 29. Long-read transcriptomics highlights venom gland specialization and Inhibitor Cystine Knot (ICK) rich toxin diversity in Philippine tarantulas
...
### 30. A quantum-classical hybrid framework for optimal energy storage systems planning
